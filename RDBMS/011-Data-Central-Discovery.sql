...
('DEV', 'SessionManagementService', 'SessionValidatorClassName', 'com.TBD.backbone.services.session.PassThruSessionValidator'),
...
('DEV', 'ConfigService', 'SessionValidatorClassName', 'com.TBD.backbone.services.session.DefaultSessionValidator'),
...
('DEV', 'CryptoService', 'SessionValidatorClassName', 'com.TBD.backbone.services.session.DefaultSessionValidator'),
...
('DEV', 'LoggingService', 'SessionValidatorClassName', 'com.TBD.backbone.services.session.PassThruSessionValidator'),
...
('DEV', 'IdService', 'SessionValidatorClassName', 'com.TBD.backbone.services.session.DefaultSessionValidator'),
...
('DEV', 'AuthenticationService', 'SessionValidatorClassName', 'com.TBD.backbone.services.session.PassThruSessionValidator'),
...
('DEV', 'UserPreferenceService', 'SessionValidatorClassName', 'com.TBD.backbone.services.session.DefaultSessionValidator'),
